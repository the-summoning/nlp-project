...
\title{NLP 2025-2026 Homeworkp report}
...
\minisection{Use of GenAI and LLM tools} Students are required to write a statement of the usage they used in the report and in their experimentation with Generative AI tools such as LLMs, as well as Vibe Coding, Codex, etc. Please be as specific as possible on which tools you use and why. We hope to discourage situations where we find a citation that is completely invented by an LLM. You can use these tools, but it is your primary responsibility for the content and material that you submit.   If we find that you used some of these tools in ways you did not disclose, it may affect your grade.
